                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="col-md-6 mt-5">
                                <button class="btn btn-primary" onclick="create_modal()" ><i class="fa fa-plus "></i>Create Record</button>
                            </div>
                            <div class="card-body">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Create New Record</h5>
          ...
          <form id="frmClaims" method="POST" name="frmClaims" onsubmit="return false">
            <div class="form-group">
                ...
                <label for="lblstaffname" id="lblclaimscat">Record Category Name:</label>
  ...
  $('form#frmClaims').submit(function(){
    ...
    var hod = $('#hod').val();
        ...
        var status = "";
            ...
            if(claimscategory == ""){
                $('#claimscategoryerror').html('Record Category cannot be empty for staff Record').addClass('text-danger');
                status = true;
            }else{
        ...
        if(status != true){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    alert("Unable to Create Record, try lategr");
                }, 
